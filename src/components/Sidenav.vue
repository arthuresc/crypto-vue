<template>
  <div class="mobile:bg-slate-950 desktop:bg-slate-900 mobile:col-span-1 desktop:col-span-3 row-start-1 row-end-17 border-r-2 border-slate-700">
    <div class="bg-slate-900 flex justify-center items-center h-28">
